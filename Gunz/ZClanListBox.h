...
protected:
	...
	MBitmap*			m_pRoomFrame, *AntiLead,*Lead, *TeamDeathMatch, *Gladiator, *BaseRotation, *Base;
	MBitmap*            m_pRoomDodgeFrame;
...
public:
	...
	void SetInfo(int nIndex, int nEmblemID, const char *szName, int nPlayers, bool bIsAntiLead, int GameType, bool bDodge, bool bRobase);
