...
DECLARE_LISTENER(ZGetWindowChangeRestartListener)
DECLARE_LISTENER(ZGetWindowChangeCancelListener)
...
DECLARE_LISTENER(ZGetVoiceVolumeSizeSliderListener)
