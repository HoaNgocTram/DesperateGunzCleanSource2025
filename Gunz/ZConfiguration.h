...
#ifdef _TRAILCOLOR
	uint32_t bTrailColors = 0xFFFFFFFF;
	int         bTrailBoxColors;
	int         bTrailCheck;
#endif
...
private:
	...
	bool                bCamFix{};
	bool                InterfaceFix{}; //Custom: FOV Camera Add By Desperate
	bool                UnlockedDir{};
...
//	bool	GetIMESupport()			{ return m_Locale.bIMESupport; }
	...
	float GetFOV() const { return FOV; } //Custom: FOV Camera Add By Desperate
...
#define ZTOK_ETC_SWORDCOLOR			"SWORDCOLOR"
...
// Custom: Volumen VoiceChat.
#define ZTOK_ETC_VOICE_VOLUMEN		"VOICE_VOLUME"
...
#define ZTOK_ETC_CODECHAT           "CHATCODE"
#define ZTOK_ETC_PERSON             "PERSON"
#define ZTOK_ETC_COLORS             "PINCOL"

#ifdef _TRAILCOLOR
#define ZTOK_ETC_TRAILCOLOR         "TRACOL"
#define ZTOK_ETC_TRAILBOXCOLOR      "TRACOLBOX"
#define ZTOK_ETC_TRAILCHECK      "TRAILCHECK"
#endif
...
#define ZTOK_ETC_DYNAMICRESOURCE    "DYNAMIC"
#define ZTOK_ETC_POSTURECHAR        "POSTURE"
#ifdef _KILLFEED
#define ZTOK_ETC_KILLFEED           "FEED"
#endif
#ifdef _FLOATDMG
#define ZTOK_ETC_FLOATDMG			"FLOATDMG"
#endif

#ifdef _CHATBACKGROUND
#define ZTOK_ETC_CHATBACKGROUND     "CHATBACKGROUND"
#define ZTOK_ETC_DISCORD            "DISCORDSTATUS"
#define ZTOK_ETC_CHATOPACITY        "TRASPARENTCHAT"
#define ZTOK_ETC_VISIBLE            "VISIBLE"
...
#define ZTOK_INSTANT                "INSTANTLOGIN"
...
// Custom: Volumen VoiceChat.
#define Z_ETC_VOICE_VOLUME	    (ZGetConfiguration()->GetEtc()->nVoiceVolumen)
...
#define Z_ETC_TRAILBOXCOLOR        (ZGetConfiguration()->GetEtc()->bTrailBoxColors)
#define Z_ETC_TRAILCHECK        (ZGetConfiguration()->GetEtc()->bTrailCheck)
#endif
...
#endif
#define Z_ETC_INSTANT_LOGIN 	(ZGetConfiguration()->GetEtc()->bInstantLogin)
#define Z_ECT_NOFOG    	    (ZGetConfiguration()->GetEtc()->bNoFog)
#define Z_ECT_CODECHAT	    (ZGetConfiguration()->GetEtc()->bCodeChat)
#define Z_ECT_RT     	    (ZGetConfiguration()->GetEtc()->bRespawnTrasparent)
#define Z_ECT_VISIBLE     	    (ZGetConfiguration()->GetEtc()->bVisible)
...
#ifdef _KILLFEED
#define Z_ETC_KILLFEED              (ZGetConfiguration()->GetEtc()->bFeed)
#endif
#ifdef _FLOATDMG
#define Z_ETC_FLOATDMG             (ZGetConfiguration()->GetEtc()->bFloatdmg)
#endif
...
#endif
#define Z_ETC_DISCORD	(ZGetConfiguration()->GetEtc()->bDiscord)
#define Z_ETC_DYNAMIC	(ZGetConfiguration()->GetEtc()->bDynamicLoad)
