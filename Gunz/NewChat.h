...
constexpr uint32_t CHAT_DEFAULT_TEXT_COLOR = XRGB(0xC8, 0xC8, 0xC8);
constexpr uint32_t CHAT_DEFAULT_INTERFACE_COLOR = XRGB(0x13, 0x13, 0x13);
constexpr uint32_t CHAT_DEFAULT_SELECTION_COLOR = ARGB(0xA0, 0, 0x80, 0xFF);
constexpr uint32_t CHAT_DEFAULT_BACKGROUND_COLOR = 0x00000000; // 100% opacity / invisible
constexpr uint32_t CHAT_BACKGROUND_COLOR_T_BLACK = 0x7D000000; // translucid black
constexpr uint32_t CHAT_BACKGROUND_COLOR_T_WHITE = 0x7DFFFFFF; // translucid white
constexpr uint32_t CHAT_BACKGROUND_COLOR_O_BLACK = 0xFF000000; // opaque black
constexpr uint32_t CHAT_BACKGROUND_COLOR_O_WHITE = 0xFFFFFFFF; // opaque white
...
public:
	...
	//D3DCOLOR SetBGColor(int nVal);

	void SwitchColors(D3DCOLOR Color) { }
...
private:
	...
	u32 BackgroundColor = CHAT_BACKGROUND_COLOR_T_BLACK;
