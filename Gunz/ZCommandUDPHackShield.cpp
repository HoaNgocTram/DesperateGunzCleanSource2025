...
void ZCommandUDPHackShield::Init()
{
	...
	AddDeniedCommand(MC_MATCH_JOIN_LADDERWARS);
	AddDeniedCommand(MC_MATCH_LADDERWARS_SIDERANK);
	...
	AddDeniedCommand(MC_MATCH_RESPONSE_GAME_INFO_V2); // Custom: Larger Game Info Packet
	...
	AddDeniedCommand(MC_MATCH_GAME_CHAT);
	...
	// Custom: Server-sided custom commands
	AddDeniedCommand(MC_ADMIN_SUMMON);
	AddDeniedCommand(MC_ADMIN_GOTO);
	AddDeniedCommand(MC_ADMIN_SLAP);
	AddDeniedCommand(MC_ADMIN_SPAWN);
	AddDeniedCommand(MC_ADMIN_SPAWN_RESPONSE);
	AddDeniedCommand(MC_ADMIN_PKICK);
	AddDeniedCommand(MC_ADMIN_NAT);
	AddDeniedCommand(MC_VIP_ANNOUNCE);
	...
	AddDeniedCommand(MC_MATCH_GUNGAME_WEAPONDATA);
	AddDeniedCommand(MC_ADMIN_KICKALL);
	AddDeniedCommand(MC_ADMIN_GIVE_COINSCASH);
	AddDeniedCommand(MC_ADMIN_GIVE_COINSMEDALS);
	AddDeniedCommand(MC_ADMIN_FREEZE_ALL);
#ifdef _NOLEAD
	AddDeniedCommand(MC_PEER_NOLEAD);
	AddDeniedCommand(MC_PEER_NOLEADBLOB);
#endif
	//Banderas
#ifdef _COUNTRYFLAG
	AddDeniedCommand(MC_GUNZ_SEND_COUNTRYCODE);
#endif
	...
	AddDeniedCommand(MC_MATCH_SPY_ROUNDRESULT);
	AddDeniedCommand(MC_SPY_GAME_SCORE);
#ifdef _GRADECHANGE
	AddDeniedCommand(MC_UGRADEID_SEND);
#endif
#ifdef _VOICE_CHAT
	AddDeniedCommand(MC_MATCH_SEND_VOICE_CHAT);
	AddDeniedCommand(MC_MATCH_RECEIVE_VOICE_CHAT);
#endif
#ifdef _HWID
	AddDeniedCommand(MC_MATCH_BANME);
#endif
	AddDeniedCommand(MC_ADMIN_SBTEST);

	/*AddDeniedCommand(MC_PEER_SET_SWORD_COLOR);*/
#ifdef _SPEC 1
	AddDeniedCommand(MC_MATCH_REQUEST_SPEC);
	AddDeniedCommand(MC_MATCH_RESPONSE_SPEC);
	AddDeniedCommand(MC_PEER_SPEC);
	AddDeniedCommand(MC_PEER_MOVE_DELTA);
#endif
#ifdef _PORTALGUN 1
	AddDeniedCommand(MC_MATCH_REQUEST_SPAWN_GAMEPORTAL);
	AddDeniedCommand(MC_REQUEST_MOVETO_GAMEPORTAL);
	AddDeniedCommand(MC_RESPONSE_MOVETO_GAMEPORTAL);
#endif
