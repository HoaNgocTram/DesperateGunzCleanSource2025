...
bool ZItem::Reload()
{
	...
	{
		m_nBulletSpare.Set_CheckCrc(9999);
		return true;
	}
	...
	if (ZGetGame()->GetMatch()->IsTraining() && GetRGMain().TrainingSettings.InBullet)
	{
		m_nBulletCurrMagazine.Set_CheckCrc(500);
		m_nBulletSpare.Set_CheckCrc(500);
		return true;
	}
