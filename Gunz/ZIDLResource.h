...
class ZLadderWarsRankingListBox;
class ZServerView;
class ZActionKey;
...
protected:
	...
	ZShopEquipListbox* GetEquipmentListBox(MXmlElement& element);
	...
	ZLadderWarsRankingListBox* GetLadderWarsRankingListBox(MXmlElement& element);
