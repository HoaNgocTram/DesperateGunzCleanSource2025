...
//	virtual void OnDamage(int damage, float fRatio = 1.0f);
	...
	virtual float __forceinline OnDamagedCalc(ZObject* pAttacker, rvector srcPos, ZDAMAGETYPE damageType, MMatchWeaponType weaponType, float fDamage, float fPiercingRatio = 1.f, int nMeleeType = -1);
