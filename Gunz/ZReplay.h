...
// Custom: Added support for old replays.
...
// Custom: maximogunz replay
#define GUNZ_REC_FILE_VERSION	10 //necessary for status to work
...
struct MTD_CharInfo_v0	// ver0 ver1
{
	...
	// 아이템 정보
	unsigned long int	nEquipedItemDesc[13];		// MMatchCharItemParts_v0::MMCIP_END0
...
struct MTD_CharInfo_v8
{
	...
	// 아이템 정보
	unsigned long int	nEquipedItemDesc[23];
	...
	// 아이템 정보 추가
	MUID				uidEquipedItem[23];
	unsigned long int	nEquipedItemCount[23];
	unsigned long int	nEquipedItemRarity[23];
	unsigned long int	nEquipedItemLevel[23];
};

struct MTD_CharInfo_v9
{
	char				szName[MATCHOBJECT_NAME_LENGTH];
	char				szClanName[CLAN_NAME_LENGTH];
	MMatchClanGrade		nClanGrade;
	...
	// 아이템 정보
	unsigned long int	nEquipedItemDesc[24];
	...
	// 아이템 정보 추가
	MUID				uidEquipedItem[24];
	unsigned long int	nEquipedItemCount[24];
	unsigned long int	nEquipedItemRarity[24];
	unsigned long int	nEquipedItemLevel[24];
};
