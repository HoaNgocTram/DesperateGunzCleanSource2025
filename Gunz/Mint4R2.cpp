...
void MDrawContextR2::FillRectangleW(int x, int y, int cx, int cy)
{
	...
	//{
	//	x = (x*800+80*RGetScreenWidth())/960.f;// debug
	//	//x = ( 800*x+90*RGetScreenWidth() )/960.f;
	//	cx = int(cx*800.f/960.f); // debug
	//	//cx = int(cx*800.f/960.f);
	//}
...
{
	/// ÆùÆ® »ý¼º Á¤º¸µéÀ» ÀúÀåÇØµÐ´Ù, º°µµ·Î ´Ù·ç¾îÁö´Â °ªµéÀº Á¦¿Ü ////
