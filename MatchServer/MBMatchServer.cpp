...
bool MBMatchServer::InitSubTaskSchedule()
{
	...
	if( MSM_CLAN == MGetServerConfig()->GetServerMode() ){
		// Custom: Don't add clan down schedule data
...
{
	// Custom: Added matchserver to the keeper list
	if( uidKeeper == MUID( 2, 0 ) )
		return true;
...
#ifdef LOCALE_NHNUSA_DIS // Custom: Disabled NHN auth
