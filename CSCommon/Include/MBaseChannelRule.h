...
#define MCHANNEL_RULE_LEAD_STR			"lead"	

#ifdef _CHANNELNEW
#define MCHANNEL_RULE_NEWUSER_STR		"news"
#endif
...
#ifdef _LIGHTURNOFF
	bool ExistAsLightMap(int nMapID);
	bool ExistAsLightMap(const char* pszMapName);
#endif
...
public:
	...
	bool CheckCTFMap(const char* pszMapName)
	{
...
#ifdef _LIGHTURNOFF
	bool CheckLightMap(const char* pszMapName)
	{
		return m_MapList.ExistAsLightMap(pszMapName);
	}
	bool CheckLightMap(int nMapID)
	{
		return m_MapList.ExistAsLightMap(nMapID);
	}
#endif
