...
protected:
	...
	virtual void RouteWeaponData(MUID& uidPlayer, int nWeaponLevel);
	virtual void RouteWeaponDataToJoiner(MUID& uidSendTo);
public:
	...
	MGunGameData m_GunGameData; 
};

class MMatchRuleTurbo : public MMatchRule {
protected:
	bool CheckKillCount(MMatchObject* pOutObject);
	virtual void OnBegin();
	virtual void OnEnd();
	...
	virtual bool RoundCount();
public:
	MMatchRuleTurbo(MMatchStage* pStage);
	virtual ~MMatchRuleTurbo() { }
	virtual MMATCH_GAMETYPE GetGameType() { return MMATCH_GAMETYPE_TURBO; }
};

// Custom: Ghost Mode - Desperate
class MMatchRuleGhost : public MMatchRule {
protected: 
		 bool GetAliveCount(int* pRedAliveCount, int* pBlueAliveCount); 
		 virtual void OnBegin(); 
		 virtual void OnEnd(); 
		 ...
		 virtual bool OnCheckEnableBattleCondition(); 
 public: 
		 MMatchRuleGhost(MMatchStage* pStage); 
		 virtual ~MMatchRuleGhost() {}
		 virtual void CalcTeamBonus(MMatchObject* pAttacker, MMatchObject* pVictim, 
			 int nSrcExp, int* poutAttackerExp, int* poutTeamExp); 
		 virtual MMATCH_GAMETYPE GetGameType() { return MMATCH_GAMETYPE_GHOST; }
