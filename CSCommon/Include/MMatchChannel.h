...
struct MCHANNELLISTNODE {
	...
	int             nPlayerOn;                      //Custom: Player Online
...
private:
	...
	bool			m_bIsUseEvent;			// Custom: Event channels
...
public:
	bool Create(const MUID& uid, const char* pszName, const char* pszRuleName, 
				...
				const bool bIsTicketChannel = false, const DWORD dwTicketItemID = 0, const bool bIsUseTicket = false, const bool bIsUseEvent = false,
...
public:
	...
	const bool	IsUseEvent()		{ return m_bIsUseEvent; }
