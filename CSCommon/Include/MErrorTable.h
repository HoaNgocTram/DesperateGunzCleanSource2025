...
#define MERR_FAILED_GETACCOUNTINFO							10008	///< 계정 정보를 가져올 수 없어서 로그인을 할 수 없다.
#define MERR_FAILED_MD5_NOT_MATCH							10009   ///< MD5가 잘못되었습니다.
#define MERR_FAILED_TOO_FASTCONNECTION						10010   ///< 너무 빠른 접속 시도입니다.
#define MERR_FAILED_BLOCK_IP								10011   ///< 블럭된 IP입니다 - Country IP Block
#define MERR_FAILED_NHNUSA_INVALID_AUTHSTR					10012	///< [NHNUSA] 인증키가 유효하지 않다.(인증키 시간 만료인 경우가 많음. 클라 재실행하도록 안내)
#define MERR_FAILED_NETMARBLE_KOR_CANT_GET_ACCOUNTINFO		10013	///< 넷마블 로그인 정보를 가져오는데 실패했습니다. 오류가 지속되면 문의바랍니다.
#define MERR_ACCOUNT_CREATED								10015   //// Register Login GunZStreak
// Custom: Prompt User to Update their IP (ill let dave handle this)
#define MERR_FAILED_LOGIN_INVALID_IP						10014
// 캐릭터 관리 관련
...
#define MERR_BRING_BACK_ACCOUNTITEM_NOT_SPENDABLE			20019	///< 캐쉬아이템만 중앙은행에 넣을 수 있습니다.
#define MERR_TAKEOFF_ITEM_BY_LEVELDOWN						20020	///< 레벨다운으로 아이템이 벗겨졌습니다.
#define MERR_CANNOT_CAHNGE_THIS_ITEM						20021	///< 레벨다운으로 아이템이 벗겨졌습니다.
#define MERR_CANNOT_SELL_TOO_MANY_ITEMCOUNT					20022	///< 해당 아이템의 갯수가 이상하다.
#define MERR_CANNOT_SELL_NOT_SPENDABLEITEM					20023	///< 중복 아이템이 아닌데, 개수가 지정되어 있다.
#define MERR_TOO_EXPENSIVE_CASH					            20023	/// Cash
#define MERR_TOO_EXPENSIVE_MEDAL					        20024	/// Medal
#define MERR_TOO_EXPENSIVE_EVENT					        20025	/// Event
...
// 입장권 관련.
#define MERR_CANNOT_JOIN_NEED_TICKET						30024	///< 입장권이 없어 들어갈 수 없습니다.
#define MERR_CANNOT_START_NEED_TICKET						30025	///< 입장권이 없는 유저가 있어 게임을 시작할 수 없습니다.
...
#define MERR_CLAN_MEMBER_KICKED								30053	// Custom: Clan Member Kicked

// 동의관련

// 래더관련
#define MERR_LADDER_CANNOT_CHALLENGE						30070	///< 클랜전을 신청할 수 없습니다.
...
#define MERR_LADDER_NOT_SERVICE_TIME						30074	///< 현재 클랜전 서비스 시간이 아닙니다. 오전 10시에 오픈됩니다.
...
#define MERR_FIND_INVALIDFILE								130004	/// 잘못된 파일이 검출 되었습니다.
#define MERR_FIND_FLOODING									130005	/// 플러딩 공격 검출.
#define MERR_BLOCK_BY_ADMIN									130006	/// 운영자에의해 블럭. 1시간 블럭
#define MERR_BLOCK_SLEEP_ACCOUNT							130007	/// 휴면 계정으로 분류된 회원의 경우, 무한 블럭이다.
#define MERR_CLEANING_CLIENT								130008	/// 정해진 시간 이상, 아무런 동작을 취하지 않을 때..


// Duel Tournament 관련.. Added By 홍기주(2009-09-25)
#define MERR_DT_WRONG_CHANNEL								140000	///< 듀얼 토너먼트 채널이 아니라서 신청 실패!
#define MERR_DT_ALREADY_JOIN								140001	///< 이미 듀얼 토너먼트 참가 신청을 했습니다.
#define MERR_DT_CANNOT_CHALLENGE							140002	///< 참가 신청이 실패했습니다.
#define MERR_DT_CHALLENGE_TIMEOUT							140003	///< 참가 신청 제한 시간이 초과되었습니다.
#define MERR_DT_CANNOT_MAKE_STAGE							140004	///< Stage를 생성하지 못했습니다.
#define MERR_DT_CANNOT_FIND_STAGE							140005	///< Stage를 찾지 못했습니다.
#define MERR_DT_CANNOT_WRONG_STAGE_SETTING					140006	///< Stage 설정이 이상합니다.
#define MERR_DT_CANNOT_START_STAGE							140007	///< Stage를 시작할 수 없습니다.
#define MERR_DT_CANNOT_ACCESS_DB							140008	///< DB와의 통신이 원활하지 않습니다.
#define MERR_DT_NOT_SERVICE_TIME							140009	///< 현재 듀얼토너먼트 서비스 시간이 아닙니다.(오픈시간 %d시00분 ~ %d시59분)

// Admin 관련 명령어.. Added By 홍기주(2010-08-11)
#define MERR_ADMIN_NO_TARGET								150000	///< 처벌할 대상이 없습니다.
#define MERR_ADNIN_CANNOT_PENALTY_ON_DB						150001	///< DB와의 통신이 원활하지 않습니다.
...
#define MERR_SPY_LACKING_PLAYERS							200011

// 버프 관련 메시지
#define MERR_CANNOT_APPLY_BUFF_INFO							300000 // 버프를 적용할 수 없습니다.

#define MERR_CQ_TOO_MANY_PLAYERS							300001
#define MERR_CQ_LOW_LVL										300002

// MC_MATCH_ANNOUNCE에서 문자열 인자에 직접 문자열을 넣는대신 에러ID를 넣어보내기 위한 접두어
