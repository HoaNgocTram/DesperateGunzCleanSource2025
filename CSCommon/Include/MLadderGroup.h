...
#ifdef _BOXLEAD
	bool GetLead() { return m_bIsLead; }
	void SetLead(bool nAntiLead) { m_bIsLead = nAntiLead; }
#endif
	void SetGameType(int t) { GameType = t; }

	void SetDodge(bool nDodge) { m_bDodge = nDodge; }
	bool GetDodge() { return m_bDodge; }
#ifdef _ROTATION
	void SetRoBase(bool nRobase) { m_bRoBase = nRobase; }
	bool GetRoBase() { return m_bRoBase; }
#endif
