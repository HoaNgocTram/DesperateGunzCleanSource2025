...
struct ShopItemNode
{
	...
	ShopItemNode() : nItemID(0), nItemCount(0), bIsRentItem(false), nRentPeriodHour(0), bIsMedalItem(false), nMedalItem(0), bIsEventItem(false), nEventItem(0), fStockRate(0.0) {}
	};
...
#define MTOK_SELL_EVENT_ITEM		"eventitem"
