...
enum MASYNCJOB {
	...
	MASYNCJOB_LOG_CHAR_MODULE,
	MASYNCJOB_INSERTQUESTCHALLENGEGAMELOG,

	//////////////////////////////////////////////////////////////////////////////////////////////
	// Added By Desperate (Ladder)
	MASYNCJOB_GET_LADDER_WAR_INFO,
	MASYNCJOB_UPDATE_LADDER_WAR_INFO,
	MASYNCJOB_GET_LADDER_WAR_SIDE_RANKING,
...
class MMatchQuestChallengeGameLogInfoManager;
class MQuestChallengePlayerLogInfo;
...
class MAsyncDBJob_InsertQuestChallengeGameLog : public MAsyncJob
{
public:
	MAsyncDBJob_InsertQuestChallengeGameLog() : MAsyncJob(MASYNCJOB_INSERTQUESTCHALLENGEGAMELOG, MUID(0, 0)), m_nMasterCID(0), m_szScenarioName("")
	{
	}

	~MAsyncDBJob_InsertQuestChallengeGameLog();


	bool Input(const char* pszStageName,
		const char* pszScenarioName,
		const int nMasterCID,
		MMatchQuestChallengeGameLogInfoManager* pQGameLogInfoMgr,
		DWORD nElapsedPlayerTime);
...
private:
	...
	const char* m_szScenarioName;
	vector< MQuestChallengePlayerLogInfo* >	m_Player;
	int								m_PlayersCID[MAX_QUEST_LOG_PLAYER_COUNT];
};
