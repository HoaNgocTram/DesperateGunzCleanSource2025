...
public: 
	void Tick();
	LadderWarsData* GetWaitingGames(LadderWar Type) { return WatingGames[(int)Type].GetInstance(); }
	void MapSelection(PlayerJoiningDataStruct ReadyGame, LadderWar Type, unsigned long int NowTime);
