...
void MAddSharedCommandTable(MCommandManager* pCommandManager, int nSharedType)
{
	...
	if(nSharedType&MSCT_MATCHSERVER || nSharedType&MSCT_CLIENT){
		...
		C(MC_MATCH_CHANNEL_RESPONSE_JOIN, "Channel.ResponseJoin", "Response Join a Channel", MCDT_MACHINE2MACHINE)
			P(MPT_UID, "uidChannel")
			P(MPT_INT, "ChannelType")			// ¡¢º”«— √§≥Œ ≈∏¿‘
			P(MPT_STR, "ChannelName")			// ¡¢º”«— √§≥Œ ¿Ã∏ß
			P(MPT_BOOL, "EnableInterface");		// ∑Œ∫ÅE¿Œ≈Õ∆‰¿ÃΩ∫ ªÁøÅEø©∫Œ
		...
		C(MC_MATCH_CHANNEL_REQUEST_ALL_PLAYER_LIST, "Channel.RequestAllPlayerList", "Request Channel All Player List", MCDT_MACHINE2MACHINE)
			P(MPT_UID, "uidPlayer")
			P(MPT_UID, "uidChannel")
			P(MPT_UINT, "PlaceFilter")		// ∑Œ∫ÅE ¥ÅE‚πÅE ∞‘¿”¡ﬂ ¿Œ «√∑π¿Ãæ˚—Èø° ¥ÅE— « ≈Õ
			P(MPT_UINT, "Options")			// 0 - ¿œπ›, 1 - ≈¨∑£ø° ∞°¿‘µ«¡ÅEæ ¿∫ ªÁ∂ÅE 2 - ≥ª≈¨∑£∏∏
		...
		C(MC_MATCH_STAGE_LEAVE, "Stage.Leave", "Leave Stage", MCDT_MACHINE2MACHINE)
			P(MPT_UID, "uidPlayer")
			// P(MPT_UID, "uidStage") // º≠πˆø° ¿÷¥¬ µ•¿Ã≈Õ∏¶ ªÁøÅE—¥Ÿ.
		...
		C(MC_MATCH_RESPONSE_GAME_INFO_V2, "ResponseGameInfoV2", "Response Game Info V2", MCDT_MACHINE2MACHINE)
			P(MPT_UID, "uidStage")
			P(MPT_BLOB, "GameInfo")
			P(MPT_BLOB, "RuleInfo")
			P(MPT_BLOB, "PlayerInfo")
		...
		C(MC_MATCH_GAME_ROUNDSTATE, "Stage.RoundState", "Sync State of a StageRound", MCDT_MACHINE2MACHINE)
			...
			P(MPT_INT, "nState");
			P(MPT_INT, "nArg");
			P(MPT_UINT, "nClock") // Custom: Clock sync
		...
		C(MC_MATCH_GAME_DEAD, "Game.Dead", "Game.Dead", MCDT_MACHINE2MACHINE)
			P(MPT_UID, "Attacker");
			P(MPT_UINT, "AttackerArg");		// Exp | ∞Ê«Ëƒ°∆€ºæ∆Æ
			P(MPT_UID, "Victim");
			P(MPT_UINT, "VictimArg");		// Exp | ∞Ê«Ëƒ°∆€ºæ∆Æ
		C(MC_MATCH_GAME_TEAMBONUS, "Game.TeamBonus", "Game.TeamBonus", MCDT_MACHINE2MACHINE)
			P(MPT_UID, "CharUID");
			P(MPT_UINT, "ExpArg");			// Exp | ∞Ê«Ëƒ°∆€ºæ∆Æ
...
//			P(MPT_BLOB, "SKey")
		...
		C(MC_MATCH_RESPONSE_SELECT_CHAR, "Match.ResponseSelectChar", "Response Select Character", MCDT_MACHINE2MACHINE)
			P(MPT_INT, "Result")
			P(MPT_BLOB, "CharInfo")
			//πˆ«¡¡§∫∏¿”Ω√¡÷ºÆ P(MPT_BLOB, "CharBuffInfo")
		...
		C(MC_MATCH_RESPONSE_CREATE_CHAR, "Match.ResponseCreateChar", "Response Create Character", MCDT_MACHINE2MACHINE)
			P(MPT_INT, "Result")		// ∞·∞ÅE
			P(MPT_STR, "CharName")		// ∏∏µÈæ˚›ÅEƒ≥∏Ø≈Õ ¿Ã∏ß
		C(MC_MATCH_REQUEST_CREATE_ACCOUNT, "Match.RequestCreateAcc", "Request Create Acc", MCDT_MACHINE2MACHINE)
			P(MPT_STR, "AccName")
			P(MPT_STR, "AccPass")
			P(MPT_INT, "AccCert")
			P(MPT_STR, "RealName")
			P(MPT_INT, "Age")
			P(MPT_INT, "Sex")
		C(MC_MATCH_RESPONSE_CREATE_ACCOUNT, "Match.ResponseCreateAcc", "Response Create Acc", MCDT_MACHINE2MACHINE)
			P(MPT_STR, "Result")
		...
		C(MC_MATCH_RESPONSE_SHOP_ITEMLIST, "Match.ResponseShopItemList", "Response Shop Item List", MCDT_MACHINE2MACHINE)
			P(MPT_BLOB, "GambleItemList");		// ¿ßƒ° πŸ≤ﬁ - by SungE 2007-06-20
			P(MPT_BLOB, "ItemList");			
		...
		C(MC_MATCH_RESPONSE_CHARACTER_ITEMLIST, "Match.ResponseCharacterItemList", "Response Character Item List", MCDT_MACHINE2MACHINE)
			...
			P(MPT_INT, "Cash")
			P(MPT_INT, "Event")
			P(MPT_BLOB, "EquipItemList")		// ¿Â∫Ò«œ∞ÅE¿÷¥¬ æ∆¿Ã≈€
			P(MPT_BLOB, "ItemList");			// ¿Â∫Ò«— æ∆¿Ã≈€±˚›ÅE∆˜«‘«— ∞Æ∞˙‹÷¥¬ æ∆¿Ã≈€
			P(MPT_BLOB, "GambleItemList")		// ∞◊∫ÅEæ∆¿Ã≈€ ∏Ò∑œ
			
		C(MC_MATCH_REQUEST_EQUIP_ITEM, "MatchRequestEquipItem", "Request Equip Item", MCDT_MACHINE2MACHINE)
			P(MPT_UID, "uidChar")
			P(MPT_UID, "uidItem")		// ∞°¡ÅEæ∆¿Ã≈€ UID
			P_MINMAX(MPT_UINT, "EquipmentSlot", 0, MMCIP_END-1)		// ¿Â∫Ò«œ∞˙‹⁄ «œ¥¬ ∫Œ¿ß
		...
		C(MC_MATCH_REQUEST_TAKEOFF_ITEM, "MatchRequestTakeoffItem", "Request Takeoff Item", MCDT_MACHINE2MACHINE)
			P(MPT_UID, "uid")
			P_MINMAX(MPT_UINT, "EquipmentSlot", 0, MMCIP_END-1)		// π˛∞˙‹⁄ «œ¥¬ ∫Œ¿ß
		...
		C(MC_MATCH_REQUEST_PROPOSAL, "Match.RequestProposal", "Request Proposal", MCDT_MACHINE2MACHINE)
			P(MPT_UID, "uidChar")			// ø‰√ª«— ƒ≥∏Ø≈Õ UID
			P(MPT_INT, "ProposalMode")		// µø¿« ¡æ∑ÅE- MMatchProposalMode¿« int«ÅE
			P(MPT_INT, "RequestID")			// ø‰√ªID - ≈¨∂Û¿Ãæ∆Æ∞° ¿”¿«∑Œ ∞·¡§«—¥Ÿ. ¿⁄Ω≈∏∏ æÀ∞ÅE¿÷¿∏∏ÅEµ .
			P(MPT_INT, "ReplierCount")		// µø¿«∏¶ π∞æ˚÷º ªÁ∂˜ºÅE
			P(MPT_BLOB, "ReplierCharNames")	// µø¿«¿⁄ ƒ≥∏Ø≈Õ ¿Ã∏ß - AskCount∏∏≈≠¿Ã BLOBø° µÈæ˚‹÷¥Ÿ.
		C(MC_MATCH_RESPONSE_PROPOSAL, "Match.ResponseProposal", "Response Proposal", MCDT_MACHINE2MACHINE)
			P(MPT_INT, "Result")			// ∞·∞ÅE
			P(MPT_INT, "ProposalMode")		// µø¿« ¡æ∑ÅE- MMatchAgreementMode¿« int«ÅE
			P(MPT_INT, "RequestID")			// ø‰√ªID
		C(MC_MATCH_ASK_AGREEMENT, "Match.AskAgreement", "Ask Agreement", MCDT_MACHINE2MACHINE)
			P(MPT_UID,	"uidProposer")		// ¡¶æ»¿⁄ ƒ≥∏Ø≈Õ UID
			P(MPT_BLOB,	"MembersCharName")	// ¬ÅE©¿⁄ ƒ≥∏Ø≈Õ ¿Ã∏ßµÅE
			P(MPT_INT,	"ProposalMode")		// µø¿« ¡æ∑ÅE- MMatchAgreementMode¿« int«ÅE
			P(MPT_INT,	"RequestID")		// ø‰√ªID
		C(MC_MATCH_REPLY_AGREEMENT, "Match.ReplyAgreement", "Reply Agreement", MCDT_MACHINE2MACHINE)
			P(MPT_UID,	"uidProposer")		// ¡¶æ»¿⁄ ƒ≥∏Ø≈Õ UID
			P(MPT_UID,	"uidChar")			// ¥‰∫Ø¿⁄ ƒ≥∏Ø≈Õ UID
			P(MPT_STR,	"Replier")			// ¥‰∫Ø¿⁄ ƒ≥∏Ø≈Õ ¿Ã∏ß
			P(MPT_INT,	"ProposalMode")		// µø¿« ¡æ∑ÅE
			P(MPT_INT,	"RequestID")		// ø‰√ª ID
			P(MPT_BOOL,	"Agreement")		// µø¿« ø©∫Œ
		...
		// ≈¨∑£ ∞ÅE√
			...
			P(MPT_UID, "uidChar")			// ø‰√ª«— ƒ≥∏Ø≈Õ UID
			P(MPT_INT, "RequestID")			// ø‰√ªID - ≈¨∂Û¿Ãæ∆Æ∞° ¿”¿«∑Œ ∞·¡§«—¥Ÿ. ¿⁄Ω≈∏∏ æÀ∞Ì ¿÷¿∏∏È µ .
			P(MPT_STR, "ClanName")			// ª˝º∫«“ ≈¨∑£ ¿Ã∏ß
#ifndef _2PCLAN
			P(MPT_STR, "Member1CharName")	// πﬂ±‚¿Œ ƒ≥∏Ø≈Õ ¿Ã∏ß
			P(MPT_STR, "Member2CharName")	// πﬂ±‚¿Œ ƒ≥∏Ø≈Õ ¿Ã∏ß
			P(MPT_STR, "Member3CharName")	// πﬂ±‚¿Œ ƒ≥∏Ø≈Õ ¿Ã∏ß
			P(MPT_STR, "Member4CharName")	// πﬂ±‚¿Œ ƒ≥∏Ø≈Õ ¿Ã∏ß  
#endif // !_2PCLAN
		...
		C(MC_MATCH_CLAN_ASK_SPONSOR_AGREEMENT, "Match.Clan.AskSponsorAgreement", "Ask Sponsor's Agreement", MCDT_MACHINE2MACHINE)
			P(MPT_INT, "RequestID")			// ø‰√ªID
			P(MPT_STR, "ClanName")
			P(MPT_UID, "uidClanMaster")		// ∏∂Ω∫≈Õ UID
			P(MPT_STR, "szClanMaster")		// ∏∂Ω∫≈Õ ¿Ã∏ß
		C(MC_MATCH_CLAN_ANSWER_SPONSOR_AGREEMENT, "Match.Clan.AnswerSponsorAgreement", "Answer Sponsor's Agreement", MCDT_MACHINE2MACHINE)
			P(MPT_INT,	"RequestID")			// ø‰√ªID
			P(MPT_UID,	"uidClanMaster")		// ∏∂Ω∫≈Õ UID
			P(MPT_STR,	"SponsorCharName")		// πﬂ±‚¿Œ ƒ≥∏Ø≈Õ ¿Ã∏ß
			P(MPT_BOOL, "Answer")				// µø¿« ø©∫Œ
		...
		C(MC_MATCH_CLAN_REQUEST_JOIN_CLAN, "Match.Clan.RequestJoinClan", "Request Join Clan", MCDT_MACHINE2MACHINE)
			P(MPT_UID, "uidChar")		// ø˚€µ¿⁄ uid
			P(MPT_STR, "ClanName")		// ≈¨∑£ ¿Ã∏ß
			P(MPT_STR, "szJoiner")		// ∞°¿‘¿⁄ ƒ≥∏Ø≈Õ ¿Ã∏ß
		...
		C(MC_MATCH_CLAN_ASK_JOIN_AGREEMENT, "Match.Clan.AskJoinAgreement", "Ask Join Agreement", MCDT_MACHINE2MACHINE)
			P(MPT_STR, "ClanName")				// ≈¨∑£ ¿Ã∏ß
			P(MPT_UID, "uidClanAdmin")			// ø˚€µ¿⁄ UID
			P(MPT_STR, "szClanAdmin")			// ø˚€µ¿⁄ ƒ≥∏Ø≈Õ ¿Ã∏ß
		C(MC_MATCH_CLAN_ANSWER_JOIN_AGREEMENT, "Match.Clan.AnswerJoinAgreement", "Answer Join Agreement", MCDT_MACHINE2MACHINE)
			...
			P(MPT_STR,	"JoinerCharName")		// ∞°¿‘¿⁄ ƒ≥∏Ø≈Õ ¿Ã∏ß
			P(MPT_BOOL, "Answer")
		...
		C(MC_MATCH_CLAN_MASTER_REQUEST_CHANGE_GRADE, "Match.Clan.Master.RequestChangeGrade", "Request Change ClanGrade", MCDT_MACHINE2MACHINE)
			P(MPT_UID, "uidClanMaster")		// ≈¨∑£ ∏∂Ω∫≈Õ
			P(MPT_STR, "szMember")			// ∫Ø∞Ê«œ∑¡∞ÅE«œ¥¬ ∏‚πÅEƒ≥∏Ø≈Õ¿Ã∏ß
			P_MINMAX(MPT_INT, "Grade", 0, MCG_END-1)				// ∫Ø∞Ê«œ∞˙‹⁄ «œ¥¬ ±««—
		...
		C(MC_MATCH_GAME_CHAT, "Match.Game.Msg", "Game Msg", MCDT_MACHINE2MACHINE)
			P(MPT_UID, "uidPlayer")
			P(MPT_UID, "uidStage")
			P(MPT_STR, "Msg")
			P(MPT_INT, "nTeam")
		...
		C(MC_MATCH_CLAN_MEMBER_CONNECTED, "Match.Clan.Member.Connected", "Member Connected", MCDT_MACHINE2MACHINE)
			P(MPT_STR, "szMember")
			P(MPT_INT, "ClanMemberGrade")

		// Custom: friend
		C(MC_MATCH_FRIEND_CONNECTED, "Match.Friend.Connected", "Friend Connected", MCDT_MACHINE2MACHINE)
			P(MPT_STR, "szFriend")
		...
		// Custom: Duel Queue Info V2
		C(MC_MATCH_DUEL_QUEUEINFO_V2, "Match.Duel.Queue Info.V2", "Queue Info V2", MCDT_MACHINE2MACHINE)
			P(MPT_BLOB, "QueueInfo")
			P(MPT_BLOB, "WaitList")
		...
		C(MC_ADMIN_SUMMON, "Admin.Summon", "Teleport player to admin", MCDT_MACHINE2MACHINE)
			P(MPT_UID, "uidPlayer")
			P(MPT_STR, "strTargetName")
		C(MC_ADMIN_FREEZE, "Admin.Freeze", "Freeze players", MCDT_MACHINE2MACHINE)
			P(MPT_UID, "uidAdmin")
			P(MPT_STR, "strTargetName")
		C(MC_ADMIN_GOTO, "Admin.GoTo", "Teleport admin to player", MCDT_MACHINE2MACHINE)
			P(MPT_UID, "uidPlayer")
			P(MPT_STR, "strTargetName")
		C(MC_ADMIN_SLAP, "Admin.Slap", "Kill player by admin", MCDT_MACHINE2MACHINE)
			P(MPT_UID, "uidPlayer")
			P(MPT_STR, "strTargetName")
		C(MC_ADMIN_SPAWN, "Admin.Spawn", "Spawn player by admin", MCDT_MACHINE2MACHINE)
			P(MPT_UID, "uidPlayer")
			P(MPT_STR, "strTargetName")
		C(MC_ADMIN_SPAWN_RESPONSE, "Admin.SpawnResponse", "Spawn player by admin response", MCDT_MACHINE2MACHINE)
			P(MPT_UID, "uidPlayer")
			P(MPT_UID, "uidVictim")
		C(MC_ADMIN_PKICK, "Admin.PKick", "Permanent kick by admin", MCDT_MACHINE2MACHINE)
			P(MPT_UID, "uidPlayer")
			P(MPT_STR, "strTargetName")
			P(MPT_BOOL, "bBan")
		C(MC_ADMIN_SILENCE, "Admin.Silence", "Silence room by admin", MCDT_MACHINE2MACHINE)
			P(MPT_UID, "uidPlayer")
			P(MPT_INT, "nDurationMin")
		C(MC_ADMIN_NAT, "Admin.NAT", "Configure NAT", MCDT_MACHINE2MACHINE)
		...
		C(MC_MATCH_GUNGAME_WEAPONDATA, "Match.GunGame.WeaponData", "Sync GunGame Weapon State", MCDT_MACHINE2MACHINE)
				P(MPT_INT, "nMaxLevel")
				P(MPT_BLOB, "data")

		C(MC_ADMIN_TEAM, "Admin.Team", "Set all player teams", MCDT_MACHINE2MACHINE)
			P(MPT_UID, "uidPlayer")
			P(MPT_INT, "nTeam")

		C(MC_MATCH_REQUEST_ROLL, "Match.DiceRollRequest", "Request RTD Roll", MCDT_MACHINE2MACHINE)
			P(MPT_UID, "uidPlayer")
			P(MPT_INT, "checksumInt")

		C(MC_MATCH_RESPONSE_ROLL, "Match.DiceRollResponse", "RTD Roll Response", MCDT_MACHINE2MACHINE)
			P(MPT_UID, "uidPlayer")
			P(MPT_INT, "actualRoll")
			P(MPT_STR, "rollEffect")



		// ƒ˘Ω∫∆Æ ∏˙”…æÅE---------------------------------------------------------------
		C(MC_QUEST_NPC_SPAWN,	"Quest.NPCSpawn", "Npc Spawn", MCDT_MACHINE2MACHINE)
			P(MPT_UID,		"uidChar")				// NPC ¡∂¡æ¿⁄
			P(MPT_UID,		"nNpcUID")				// «“¥Áµ» NPC ID
			P(MPT_UCHAR,	"nNpcType")				// NPC ¡æ∑ÅE
			P(MPT_UCHAR,	"PositionIndex")		// NPC Ω∫∆ÅE¿ßƒ° ¿Œµ¶Ω∫
		...
		C(MC_QUEST_REQUEST_NPC_DEAD,	"Quest.Request.NPCDead", "Request Npc Dead", MCDT_MACHINE2MACHINE)
			P(MPT_UID, "uidChar")		// NPC ¡∂¡æ¿⁄
			P(MPT_UID, "uidNPC")		// «“¥Áµ» NPC ID
			P(MPT_SVECTOR, "NpcPosition")	// NPC ¿ßƒ°
		C(MC_QUEST_NPC_DEAD,	"Quest.NPCDead", "Npc Dead", MCDT_MACHINE2MACHINE)
			P(MPT_UID, "uidKillerPlayer")	// ¡◊¿Œ «√∑π¿ÃæÅE
		...
		C(MC_QUEST_COMBAT_STATE, "Quest.Combat.State", "Quest Combat State", MCDT_MACHINE2MACHINE)
			P(MPT_CHAR, "CombatState")		// ƒ˘Ω∫∆Æ ∞‘¿” ªÛ≈¬

		C(MC_QUEST_SECTOR_START, "Quest.Sector.Start", "Quest Sector Start", MCDT_MACHINE2MACHINE)
			P(MPT_CHAR, "SectorIndex")		// ªı∑ŒøÅEºΩ≈Õ ¿Œµ¶Ω∫
			P(MPT_UCHAR, "RepeatIndex")		// «ˆ¿ÅEπ›∫π »ΩºÅE(º≠πŸ¿Ãπ˙øÅE

		C(MC_QUEST_COMPLETED, "Quest.Complete", "Complete Quest", MCDT_MACHINE2MACHINE)
			P(MPT_BLOB, "RewardInfo");		// ∫∏ªÅE≥ªøÅE
		C(MC_QUEST_FAILED, "Quest", "Quest failed", MCDT_MACHINE2MACHINE)	//ƒ˘Ω∫∆Æ Ω«∆–.
...
//			P(MPT_VECTOR, "Position")
		...
		C(MC_QUEST_PEER_NPC_SKILL_START,	"Quest.Peer.NPC.Skill.Start",	"NPC Skill Start", MCDT_PEER2PEER)
			P(MPT_UID, "uidOwner")		// æ¥ NPC
			P(MPT_INT, "nSkill")		// Ω∫≈≥ π¯»£
			P(MPT_UID, "uidTarget")		// target
			P(MPT_POS, "targetPos")		// ¿ßƒ°
		...
		C(MC_NEWQUEST_NPC_SPAWN,				"NewQuest.NPC.Spawn",	"NPC Spawn", MCDT_MACHINE2MACHINE)
			...
			P(MPT_UID, "uidNpc")
			P(MPT_STR, "szNpcDefName")	//todok ∆–≈∂ ¿˝æ‡¿ª ¿ß«ÿ πÆ¿⁄ø≠∏ª∞ÅEenum∞™¿ª ≥—±ÅEºÅE¿÷∞‘ «œ¿⁄
			P(MPT_UCHAR, "nSpawnType")			// NPC Ω∫∆ÅE¡æ∑ÅE¿Œµ¶Ω∫
			P(MPT_UCHAR, "PositionIndex")		// NPC Ω∫∆ÅE¿ßƒ° ¿Œµ¶Ω∫
			P(MPT_BOOL, "bIsBoss")

		C(MC_NEWQUEST_REQUEST_NPC_SPAWN, "NewQuest.Request.NPCSpawn", "NPC Spawn", MCDT_MACHINE2MACHINE)
			P(MPT_UID, "uidController")
			P(MPT_UID, "uidNpc")
			P(MPT_INT, "nNum")
			P(MPT_INT, "nIndex")
		...
		C(MC_NEWQUEST_NEW_CONTROL,	"NewQuest.New.Control",	"NPC New controller", MCDT_MACHINE2MACHINE)
			P(MPT_UID, "uidOwner")		// PLAYER
			P(MPT_UID, "uidNPC")		// NPC
	...
	if(nSharedType&MSCT_MATCHSERVER || nSharedType&MSCT_CLIENT || nSharedType&MSCT_AGENT) {
		if (nSharedType&MSCT_MATCHSERVER || nSharedType&MSCT_CLIENT || nSharedType&MSCT_AGENT) {
			...
			C(MC_SERVER_ANNOUNCE, "Server.Announce", "Announce", MCDT_MACHINE2MACHINE | MCCT_NON_ENCRYPTED)
				P(MPT_UID, "uidPlayer")
				P(MPT_STR, "Msg");

			// Custom: Packets (Global - Client, Server and Agent)
			C(MC_VIP_ANNOUNCE, "VIP.Announce", "Announce", MCDT_MACHINE2MACHINE | MCCT_NON_ENCRYPTED )
				P(MPT_UID, "uidVIP")
				P(MPT_STR, "Msg")
		...
		if (nSharedType&MSCT_MATCHSERVER || nSharedType&MSCT_CLIENT) {
			...
			// Custom: kick everyone off the stage.
			C(MC_ADMIN_KICKALL, "Admin.KickAll", "Kick everyone off the stage.", MCDT_MACHINE2MACHINE)
		}		
	}

	// ZoneServer, Master ∞¯øÅE∏˙”…æÅE
...
#ifdef _ICONCHAT
		C(MC_PEER_CHATVOICE_ICON, "Peer.ChatVoiceIcon", "ChatVoiceIcon", MCDT_PEER2PEER)
		    P(MPT_BOOL, "bIconVoice")
#endif
...
*/
		...
		C(MC_PEER_SNIFER, "Peer.Snifer", "Snifer", MCDT_PEER2PEER)
			P(MPT_BOOL, "Scope")
	}
	...
	// MatchServer, Agent, Client ∞¯øÅE∏˙”…æÅE
...
//	CA("connect", "Net.Connect");
	...
	C( MC_MATCH_USER_REWARD_QUEST, "Quest", "Quest reward.", MCDT_MACHINE2MACHINE )
		...
		// P( MPT_BLOB, "Monster bible info" ) ªÁøÅEœ¡ÅEæ ±‚∑Œ «‘.
	...
	C( MC_MATCH_RESPONSE_DROP_SACRIFICE_ITEM, "Quest", "Response drop sacrifice item", MCDT_MACHINE2MACHINE )
		...
		// P( MPT_UID, "owner of was drop." )	// MUID(0, 0)¿Ã∏ÅE∫ÅEΩΩ∑‘. πÊ¿Â¿œ ∞ÊøÅE∏ ªÁøÅE
		P( MPT_INT, "Slot index" )
		P( MPT_INT, "ItemID" )
	...
	C( MC_MATCH_RESPONSE_CALLBACK_SACRIFICE_ITEM, "Quest", "Request callback sacrifice item", MCDT_MACHINE2MACHINE )
		...
		// P( MPT_UID, "owner of was drop" )	// πÊ¿Â¿œ ∞ÊøÅE∏ ªÁøÅE
		P( MPT_INT, "Slot index" )
		P( MPT_INT, "ItemID" )
	...
	// XTRAP 4.1ø°¥¬ ªÁøÅEœ¡ÅEæ ¥¬¥Ÿ.(¿Ã¿ÅE˙¿« »£»Ø¿∏∑Œ µ∆ƒ¿Œ∏∏ ¡∏¿Á«—¥Ÿ.)
	...
	C(MC_MATCH_LADDERWARS_CHARINFO, "MC_MATCH_LADDERWARS_CHARINFO", "Player Wars Character Info", MCDT_MACHINE2MACHINE)
		P(MPT_INT, "Ranking")
		P(MPT_INT, "Wins")
		P(MPT_INT, "Loses")
		P(MPT_INT, "Draws")
		P(MPT_INT, "Score")
	C(MC_MATCH_LADDERWARS_COUNTER, "MC_MATCH_LADDERWARS_COUNTER", "Player Wars Counter Info", MCDT_MACHINE2MACHINE)
		P(MPT_BLOB, "Data")

	C(MC_MATCH_LADDERWARS_SIDERANK, "MC_MATCH_LADDERWARS_SIDERANK", "Player Wars Side Rank Info", MCDT_MACHINE2MACHINE)
		P(MPT_BLOB, "Data")

	C(MC_MATCH_JOIN_LADDERWARS, "Join.LadderWars", "Join Match Ladder Wars", MCDT_MACHINE2MACHINE);
		P(MPT_INT, "Arg1")
		P(MPT_INT, "Arg2")

#ifdef _CW_VOTE
	C(MC_MATCH_LADDERWARS_RANDOM_MAPS, "Maps", "Maps", MCDT_MACHINE2MACHINE)
		P(MPT_INT, "1");
	    P(MPT_INT, "2");
	    P(MPT_INT, "3");

	C(MC_MATCH_LADDERWARS_VOTE, "Maps", "Maps", MCDT_MACHINE2MACHINE)
		P(MPT_INT, "Map");

	C(MC_MATCH_LADDERWARS_VOTE_UPDATE, "Maps", "Maps", MCDT_MACHINE2MACHINE)
		P(MPT_INT, "1");
	    P(MPT_INT, "2");
	    P(MPT_INT, "3");

	C(MC_MATCH_LADDERWARS_FRIENDINVITE, "InviteFriend", "InviteFriend", MCDT_MACHINE2MACHINE)
		P(MPT_STR, "name");

	C(MC_MATCH_LADDERWARS_FRIENDACCEPT, "AcceptFriend", "AcceptFriend", MCDT_MACHINE2MACHINE)
	C(MC_MATCH_LADDERWARS_FRIENDLEAVE, "LeaveFriend", "LeaveFriend", MCDT_MACHINE2MACHINE)
	C(MC_MATCH_LADDERWARS_INVITED, "InvitedPlayer", "InvitedPlayer", MCDT_MACHINE2MACHINE)

#ifdef _LADDERWARSPACKETS
	C(MC_PEER_LADDERWARS, "Peer.LadderWars", "LadderWars", MCDT_PEER2PEER)
		P(MPT_UID, "AttackerUID")
		P(MPT_FLOAT, "damage")
#endif
	...
	C(MC_GUNZ_ANTI_LEAD_N, "Match.Gunz.AntiLead", "AntiLead Information", MCDT_PEER2PEER);
	   P(MPT_BLOB, "AntiLeadN");

#ifdef _NOLEAD
	C(MC_PEER_NOLEAD, "Peer.NoLead", "No Lead", MCDT_MACHINE2MACHINE | MCCT_NON_ENCRYPTED) 
		P(MPT_UID, "AttackerUID")
		P(MPT_UID, "TargetUID")
		P(MPT_POS, "position")
	...
	C(MC_PEER_NOLEADBLOB, "Peer.NoLeadBlob", "No Lead", MCDT_MACHINE2MACHINE | MCCT_NON_ENCRYPTED) 
		P(MPT_UID, "uid")
		P(MPT_BLOB, "blob")
#endif

	C(MC_GUNZ_DMGGIVEN, "DMGGiven", "DMGGiven", MCDT_PEER2PEER)
		P(MPT_INT, "Dmg");
		P(MPT_INT, "Type");

	C(MC_GUNZ_LASTDMG, "DMGLASTTAKEN", "DMGLASTTAKEN", MCDT_PEER2PEER)
		P(MPT_INT, "DmgGiven")
		P(MPT_INT, "DmgTaken");
		//Banderas
#ifdef _COUNTRYFLAG
		C(MC_GUNZ_SEND_COUNTRYCODE, "Send.Countrycode", "Send countrycode info to the server.", MCDT_MACHINE2MACHINE)
		P(MPT_STR, "szPlayer")
		P(MPT_INT, "nCountryCode")
#endif
#ifdef _KILLSTREAK
...
#endif
#ifdef _REPORT
	C(MC_REPORT_USER, "report", "Report Player", MCDT_MACHINE2MACHINE)
		P(MPT_STR, "strTargetName")
		P(MPT_STR, "strReason")
#endif
	C(MC_ADMIN_GIVE_COINSCASH, "Admin.Give.Cash", "Give cash to a player.", MCDT_MACHINE2MACHINE)
		P(MPT_STR, "szPlayer")
		P(MPT_INT, "nCash")

	C(MC_ADMIN_GIVE_COINSMEDALS, "Admin.Give.Medal", "Give medal to a player.", MCDT_MACHINE2MACHINE)
		P(MPT_STR, "szPlayer")
		P(MPT_INT, "nLC")

#ifdef _GRADECHANGE
	C(MC_UGRADEID_SEND, "Admin.Change.Grade", "Change Grade to a player.", MCDT_MACHINE2MACHINE)
		P(MPT_STR, "szPlayer")
		P(MPT_INT, "nUGradeID")
#endif
	...
	C(MC_ADMIN_GIVE_COINSMEDALS_RESPONSE, "CoinsM.Response", "kk", MCDT_MACHINE2MACHINE)
		P(MPT_INT, "uidObj")	// coins derp

	C(MC_STAFF_CHAT, "Staff.CHAT", "Announce", MCDT_MACHINE2MACHINE | MCCT_NON_ENCRYPTED)
	P(MPT_STR, "Msg");
	P(MPT_STR, "Name");
	P(MPT_INT, "UGrade");

#ifdef _ANTISPAM
	C(MC_ADMIN_WALL, "Admin.Wall", "Announce", MCDT_MACHINE2MACHINE | MCCT_NON_ENCRYPTED )
		P(MPT_UID, "uid");
		P(MPT_STR, "Msg");
		P(MPT_STR, "CharName");
#endif
	...
	C(MC_TELEPORT_ALL, "Admin.TeleportAll", "", MCDT_MACHINE2MACHINE)
		P(MPT_STR, "AdminName")

	C(MC_ADMIN_FREEZE_ALL, "Admin.Freeze.All", "Freeze all players.", MCDT_PEER2PEER)
		P(MPT_INT, "State");
	C(MC_PEER_SHOT_MELEE, "Peer.Shot.Melee", "ShotMelee", MCDT_PEER2PEER)
		P(MPT_FLOAT, "Time")
		P(MPT_POS, "Position")
	...
	C(MC_MATCH_SPY_ROUNDRESULT, "Round.End.Result", "", MCDT_MACHINE2MACHINE)
		P(MPT_INT, "roundarg")
	...
	C(MC_MATCH_FREEZESPY, "Match.FREEZESPY", "FREEZESPY PLAYER", MCDT_MACHINE2MACHINE);
	P(MPT_INT, "Type");
	P(MPT_STR, "Name");

	C(MC_MATCH_UNFREEZESPY, "Match.UNFREEZESPY", "UNFREEZESPY PLAYER", MCDT_MACHINE2MACHINE);
	P(MPT_INT, "Type");
	P(MPT_STR, "Name");
...
#ifdef _KILLFEED
	C(MC_FIND_WEAPON, "Find.Weapon", "FindWeapon", MCDT_PEER2PEER);
		P(MPT_INT, "weapon")
#endif

#ifdef _HWID
	C(MC_MATCH_BANME, "Match.BanMe", "Hacks", MCDT_MACHINE2MACHINE)
		P(MPT_INT, "Type")
		P(MPT_BLOB, "Stack")
	C(MC_MATCH_BANACCOUNT, "Match.BanAccount", "Ban Account", MCDT_MACHINE2MACHINE)
		P(MPT_STR, "TargetName")
#endif
	C(MC_ADMIN_SBTEST, "Match.SBTest", "SB", MCDT_MACHINE2MACHINE)
		P(MPT_UID, "uidPlayer")
		P(MPT_STR, "strTargetName")

	C(MC_ADMIN_CRASH, "Match.Admin.Crash", "", MCDT_MACHINE2MACHINE)
	...
	C(MC_SKILLMAP_OBTAIN_ITEM,"","",MCDT_MACHINE2MACHINE)
		P(MPT_UID,"targetPlayer")
		P(MPT_INT,"bonusXP")
		P(MPT_INT,"bonusBP")
#ifdef _CMD_ALL
	C(MC_ALL_CMD, "All.Cmd", "All.Cmd", MCDT_PEER2PEER)
		P(MPT_STR, "CMD1")
		P(MPT_STR, "CMD2")
		P(MPT_STR, "CMD3")
		P(MPT_UID, "uidChar")
...
#ifdef _UPCHARCMD
		C(MC_PEER_UPDATECHAR, "Peer.UpdateCharacter", "UpdateCharacter", MCDT_PEER2PEER)
			P(MPT_BLOB, "CharInfo")
#endif

#ifdef _MAGICBOX
	C(MC_DROPGUNGAME_RESPONSE_ENTERGAME, "", "", MCDT_MACHINE2MACHINE)
		P(MPT_UID, "")
		P(MPT_INT, "")
		P(MPT_INT, "")
		P(MPT_INT, "")
	...
	C(MC_DROPGUNGAME_REQUEST_ITEM, "", "", MCDT_MACHINE2MACHINE)
		P(MPT_UID, "");

	C(MC_DROPGUNGAME_RESPONSE_ITEM, "", "", MCDT_MACHINE2MACHINE)
		P(MPT_UID, "")
		P(MPT_INT, "")
		P(MPT_INT, "")
		P(MPT_INT, "")
	...
	C(MC_DROPGUNGAME_RESPONSE_WORLDITEMS, "", "", MCDT_MACHINE2MACHINE)
		P(MPT_UID, "")
		P(MPT_INT, "")
		P(MPT_FLOAT, "")
		P(MPT_FLOAT, "")
	...
	C(MC_INVITE_CLANWAR, "Invite.ClanWar", "Invite your team to Clan War", MCDT_MACHINE2MACHINE)

#ifdef _POSTABINFO
	C(MC_PEER_HPAP_TAB, "Peer.TabInfo", "Tab Info", MCDT_PEER2PEER)
		P(MPT_INT, "HP")
		P(MPT_INT, "AP")

	C(MC_PEER_DAMAGE_TAB, "Peer.Damage", "Peer Damage", MCDT_PEER2PEER)
		P(MPT_INT, "nDamage")
		P(MPT_UID, "uidPlayer")
		P(MPT_BOOL, "bReset")
#endif
...
#endif
#ifdef _PORTALGUN 1
	C(MC_MATCH_REQUEST_SPAWN_GAMEPORTAL, "Match.Request.Spawn.GamePortal", "Request Spawn GamePortal", MCDT_MACHINE2MACHINE);
		P(MPT_UID, "uidChar");
		P(MPT_INT, "ItemID");
		P(MPT_POS, "ItemPos");
		P(MPT_POS, "ItemDir");
	C(MC_REQUEST_MOVETO_GAMEPORTAL, "Match.GamePortal.Request.Obtain", "Obtain Request GamePortal", MCDT_MACHINE2MACHINE);
		P(MPT_INT, "nItemUID");
	C(MC_RESPONSE_MOVETO_GAMEPORTAL, "Match.GamePortal.Response.Obtain", "Obtain Response GamePortal", MCDT_MACHINE2MACHINE);
		P(MPT_POS, "nPos");
#endif
