...
////////////////////////////////////////////////////////////////////////////
MMatchNPCManager::MMatchNPCManager() : m_pStage(NULL), m_nLastSpawnTime(0), m_pPlayerManager(0), m_nBossCount(0), m_bBossDie(false), m_bKeyNPCDie(false)
{
...
MMatchNPCObject* MMatchNPCManager::CreateNPCObject(MQUEST_NPC nType, unsigned char nSpawnPositionIndex, bool bKeyNPC)
{
...
void MMatchNPCManager::ClearKeyNPCState()
{
	m_uidKeyNPC.SetZero();
	m_bKeyNPCDie = false;
}
