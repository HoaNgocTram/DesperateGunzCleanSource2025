...
#define MMATCH_GAMETYPE_TRAINING_STR			"Training(Solo)" 
...
#define MMATCH_GAMETYPE_LADDERWARS_STR			"Ladder War"
...
#define MMATCH_GAMETYPE_TURBO_STR			    "Staff Mode"
#define MMATCH_GAMETYPE_SKILLMAP_STR			"Skill Map"
...
#define MMATCH_GAMETYPE_GHOST_STR				"Ghost"			// Custom: Ghost Mode - Desperate
...
const char* MMatchGameTypeAcronym[MMATCH_GAMETYPE_MAX] = {
	...
	"PSOLO",	// PAINT_SOLO
	"PTEAM",	// PAINT_TEAM
	"GHOST",	// GHOST MODE // Custom: Ghost Mode - Desperate
...
_InitGameType(MMATCH_GAMETYPE_TURBO,            MMATCH_GAMETYPE_TURBO,              MMATCH_GAMETYPE_TURBO_STR,            1.0f,			1.0f,					0.0f);
_InitGameType(MMATCH_GAMETYPE_SKILLMAP,         MMATCH_GAMETYPE_SKILLMAP,           MMATCH_GAMETYPE_SKILLMAP_STR,         1.0f,         1.0f,                   0.0f);
...
_InitGameType(MMATCH_GAMETYPE_GHOST,			MMATCH_GAMETYPE_GHOST,				MMATCH_GAMETYPE_GHOST_STR,			  1.0f,			0.6f,					0.5f); // Custom: Ghost Mode - Desperate
