...

{
	...
	//Custom: Turn off create clan with level 10.
...
#ifdef _BOXLEAD
			pNode->bIsLead = pLadderGroup->GetLead();
#endif
			pNode->bDodge = pLadderGroup->GetDodge();
#ifdef _ROTATION
			pNode->bRobase = pLadderGroup->GetRoBase();
#endif
			pNode->GameType = pLadderGroup->GetGameType();
