...
public:
	...
	RAniIDEventSet* m_pAniIdEventSet;		//애니메이션 ID 이벤트 셋

	RAniNameEventSet* m_pAniNameEventSet;	//애니메이션 이름 이벤트 셋
	//이벤트 함수 셋팅
...
public:
	...
	void Pause(RAniMode amode, float frameTime);
...
public:
	...
	RWeaponMotionType* m_pSelectWeaponMotionType_AntiHack;	// 변조를 막기위해 사본을 둔다
